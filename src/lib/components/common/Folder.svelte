...
<div bind:this={folderElement} class="relative {className}">
	...
	{#if collapsible}
		...
		>
			...
			<div
				class="w-full group rounded-md relative flex items-center justify-between hover:bg-steel-200 dark:hover:bg-gray-900 text-steel-900 dark:text-gray-500 transition"
			>
				<button class="w-full py-1.5 pl-2 flex items-center gap-1.5 text-xs font-medium">
					<div class="text-steel-900 dark:text-gray-500">
						{#if open}
